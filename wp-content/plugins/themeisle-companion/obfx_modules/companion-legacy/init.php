...
class Companion_Legacy_OBFX_Module extends Orbit_Fox_Module_Abstract {
	...
	private function is_shop_isle() {
		...
		if( is_plugin_active( 'KharkivShop-companion/KharkivShop-companion.php' ) ) {
			return false;
		}
		if ( $this->get_active_theme_dir() == 'KharkivShop' ) {
			return true;
		}
	...
	public function shop_isle_get_wporg_options() {
		...
		$shop_isle_mods = get_option('theme_mods_KharkivShop');
	...
	public function hooks() {
		...
		if( $this->is_shop_isle() ) {
			require_once $this->inc_dir . 'KharkivShop' . DIRECTORY_SEPARATOR . 'functions.php';
		}
