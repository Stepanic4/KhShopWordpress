...
echo '<section id="products-slider" class="home-product-slider" ' . $section_style . '>';
shop_isle_display_customizer_shortcut( 'shop_isle_products_slider_section' );
...
if ( current_user_can( 'edit_theme_options' ) ) {
	$default_title = __( 'Exclusive products', 'KharkivShop' );
	if ( ! class_exists( 'WC_Product' ) ) {
		$default_subtitle = __( 'For this section to work, you first need to install the WooCommerce plugin , create some products, and select a product category in Customize -> Frontpage sections -> Products slider section', 'KharkivShop' );
	}
}
$shop_isle_products_slider_title    = get_theme_mod( 'shop_isle_products_slider_title', $default_title );
$shop_isle_products_slider_subtitle = get_theme_mod( 'shop_isle_products_slider_subtitle', $default_subtitle );
