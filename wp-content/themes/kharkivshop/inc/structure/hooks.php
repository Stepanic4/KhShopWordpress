 ...
 */
add_action( 'after_setup_theme', 'shop_isle_setup', 10 );
add_action( 'widgets_init', 'shop_isle_widgets_init', 10 );
 ...
 */
add_action( 'shop_isle_header', 'shop_isle_the_very_top_bar', 40 );
