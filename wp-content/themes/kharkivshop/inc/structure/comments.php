		...
		<div class="comment-body">
			<div class="comment-meta commentmetadata">
				<div class="comment-author vcard">
					...
					printf( __( '<cite class="fn">%s</cite>', 'KharkivShop' ), get_comment_author_link() );
					?>
				</div>
				<?php if ( '0' == $comment->comment_approved ) : ?>
					<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'KharkivShop' ); ?></em>
					<br />
				<?php endif; ?>
			</div>
			...
			<div class="comments-bottom-wrap">
				...
				<div class="reply">
					...
					?>
					<?php edit_comment_link( __( 'Edit', 'KharkivShop' ), '  ', '' ); ?>
				</div>
			</div>
