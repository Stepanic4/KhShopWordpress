	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Shopisle_Customizer_Upsell_Main(
				...
				'shopisle-upsell',
				array(
					'upsell_title' => __( 'KharkivShop', 'KharkivShop' ),
					'label_url'    => 'http://docs.themeisle.com/article/421-KharkivShop-documentation-wordpress-org',
					'label_text'   => __( 'Documentation', 'KharkivShop' ),
				)
			)
		);
			...
			new Shopisle_Customizer_Upsell_Section(
				...
				array(
					...
					'options'     => array(
						...
						esc_html__( 'Ribbon Section', 'KharkivShop' ),
						esc_html__( 'Services Section', 'KharkivShop' ),
						esc_html__( 'Shortcodes Section', 'KharkivShop' ),
					),
				...
				new Shopisle_Customizer_Upsell_Text(
					...
					array(
						...
						sprintf(
							...
							__( 'To customize the Frontpage sections please create a page. After that, go to %1$s and select "A static page". Finally, for "Front page" choose the page you previously created.', 'KharkivShop' ),
							sprintf(
								...
								esc_html__( 'Static Front Page', 'KharkivShop' )
							)
						) . '<br><br>' . sprintf(
