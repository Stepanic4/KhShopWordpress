...
function shop_isle_slider_shortcode_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		'shop_isle_homepage_slider_shortcode',
		array(
			'label'           => __( 'Slider shortcode', 'KharkivShop' ),
			'description'     => __( 'You can replace the homepage slider with any plugin you like, just copy the shortcode generated and paste it here.', 'KharkivShop' ),
