...
function shop_isle_products_controls_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			'default'     => false,
			'title'       => __( 'Products section', 'KharkivShop' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Hide products section?', 'KharkivShop' ),
	...
	$wp_customize->add_setting(
		...
		array(
			'transport'         => $selective_refresh,
			'sanitize_callback' => 'shop_isle_sanitize_text',
			'default'           => __( 'Latest products', 'KharkivShop' ),
		)
	);
	...
	$wp_customize->add_control(
		'shop_isle_products_shortcode',
		array(
			'label'       => __( 'WooCommerce shortcode', 'KharkivShop' ),
			'section'     => 'shop_isle_products_section',
			'description' => __( 'Insert a WooCommerce shortcode', 'KharkivShop' ),
			'priority'    => 3,
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'description' => __( 'OR pick a product category. If no shortcode or no category is selected , WooCommerce latest products are displaying.', 'KharkivShop' ),
			'section'     => 'shop_isle_products_section',
