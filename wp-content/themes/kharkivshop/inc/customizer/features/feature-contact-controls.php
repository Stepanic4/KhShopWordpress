...
function shop_isle_contact_page_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		'shop_isle_contact_page_section',
		array(
			'title'    => __( 'Contact page', 'KharkivShop' ),
			'priority' => 99,
		)
	);
	...
	$wp_customize->add_setting(
		'shop_isle_contact_page_form_shortcode',
		array(
	...
	$wp_customize->add_control(
		'shop_isle_contact_page_form_shortcode',
		array(
			'label'           => __( 'Contact form shortcode', 'KharkivShop' ),
			'description'     => sprintf(
				/* translators: 1: Link to WPForms Plugin. */
				__( 'Create a form, copy the shortcode generated and paste it here. We recommend %1$s but you can use any plugin you like.', 'KharkivShop' ),
				sprintf(
					/* translators: 1: 'WPForms' */
					'<a href="https://wordpress.org/plugins/wpforms-lite/" target="_blank">%s</a>',
					'WPForms Lite'
				)
			),
	...
	/* Map ShortCode  */
	$wp_customize->add_setting(
		'shop_isle_contact_page_map_shortcode',
		array(
			'sanitize_callback' => 'shop_isle_sanitize_text',
		)
	);
	...
	$wp_customize->add_control(
		'shop_isle_contact_page_map_shortcode',
		array(
			'label'           => __( 'Map shortcode', 'KharkivShop' ),
			'description'     => __( 'To use this section please install <a href="https://wordpress.org/plugins/intergeo-maps/">Intergeo Maps</a> plugin then use it to create a map and paste here the shortcode generated', 'KharkivShop' ),
			'section'         => 'shop_isle_contact_page_section',
			'active_callback' => 'shop_isle_is_contact_page',
			'priority'        => 2,
		)
	...
	$wp_customize->add_section(
		'shop_isle_contact_page_instructions',
		array(
			'title'    => __( 'Contact page', 'KharkivShop' ),
			'priority' => 99,
		)
