...
function shop_isle_404_page_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'shop_isle_404_background',
			array(
				'label'    => __( 'Background image', 'KharkivShop' ),
	...
	$wp_customize->add_setting(
		...
		array(
			...
			'default'           => __( 'Error 404', 'KharkivShop' ),
			'transport'         => 'postMessage',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'sanitize_callback' => 'shop_isle_sanitize_text',
			'default'           => __( 'The requested URL was not found on this server.<br> That is all we know.', 'KharkivShop' ),
			'transport'         => 'postMessage',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'sanitize_callback' => 'shop_isle_sanitize_text',
			'default'           => __( 'Back to home page', 'KharkivShop' ),
			'transport'         => 'postMessage',
		)
	);
