	...
	if ( have_posts() ) {
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-8 KharkivShop-page-content">
					<?php
					...
					<div class="pagination font-alt">
						<?php next_posts_link( __( '<span class="meta-nav">&laquo;</span> Older posts', 'KharkivShop' ) ); ?>
						<?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&raquo;</span>', 'KharkivShop' ) ); ?>
						</div>
						<!-- Pagination end -->
						</div>
						<!-- Content column end -->
