jQuery(document).ready(function(){
    ...
    if( typeof customize !== 'undefined' && customize.hasOwnProperty( 'previewer' ) ) {
        customize.previewer.bind(
            'KharkivShop-customize-focus-section', function (data) {
    ...
    jQuery('#customize-theme-controls').on('click','.KharkivShop-customize-control-title',function(){
    ...
    jQuery( '#customize-theme-controls' ).on(
        'click', '.KharkivShop-link-to-top-menu', function() {
