		...
		?>
			<div class="hs-caption">
				<div class="caption-content">
					<?php
						/* title */
						$shop_isle_404_title = get_theme_mod( 'shop_isle_404_title', __( 'Error 404', 'KharkivShop' ) );
					...
					if ( ! empty( $shop_isle_404_text ) ) :
						...
						$shop_isle_404_label = get_theme_mod( 'shop_isle_404_label', __( 'Back to home page', 'KharkivShop' ) );
